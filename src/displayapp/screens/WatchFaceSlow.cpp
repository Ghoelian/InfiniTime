#include "displayapp/screens/WatchFaceSlow.h"
#include <cmath>
#include <limits>
#include <lvgl/lvgl.h>
...
WatchFaceSlow::WatchFaceSlow(Controllers::DateTime& dateTimeController,
...
void WatchFaceSlow::UpdateClock() {
...
void WatchFaceSlow::SetBatteryIcon() {
  auto batteryPercent = batteryPercentRemaining.Get();
  batteryIcon.SetBatteryPercentage(batteryPercent);
}

void WatchFaceSlow::Refresh() {
